    ...
    <div className="relative min-h-screen overflow-hidden bg-[#f6f1ea]">
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-10">
        <div className="grid w-full max-w-7xl overflow-hidden rounded-[32px] border border-white/40 bg-white/70 shadow-[0_20px_80px_rgba(49,31,18,0.15)] backdrop-blur-xl lg:grid-cols-2">
          <div className="hidden lg:flex flex-col justify-between bg-[linear-gradient(135deg,#3e2723_0%,#5d4037_45%,#8d6e63_100%)] p-10 text-white">
            <div>
              <div className="inline-flex items-center gap-3 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-sm tracking-wide text-white/90">
                <span className="h-2 w-2 rounded-full bg-emerald-300" />
                Premium Multi-Company SaaS Demo
              </div>
              ...
              <p className="mt-4 max-w-md text-base leading-7 text-white/80">
                A refined central operations platform for modern cafés and
                bakery chains. Manage suppliers, streamline branch ordering, and
                keep every location aligned.
              </p>
            </div>

            <div className="grid gap-4">
              <div className="rounded-2xl border border-white/15 bg-white/10 p-5">
                <p className="text-sm text-white/70">Smart Basket</p>
                <p className="mt-2 text-lg font-medium">
                  One order, automatically split by supplier.
                </p>
              </div>

              <div className="rounded-2xl border border-white/15 bg-white/10 p-5">
                <p className="text-sm text-white/70">For Owners & Managers</p>
                <p className="mt-2 text-lg font-medium">
                  Centralized company control with branch-specific access.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="mt-8 rounded-2xl border border-[#eadccf] bg-[#fcf8f4] p-4 text-sm text-[#6b5b52]">
                ...
                <div className="mt-4 space-y-4">
                  {demoAccounts.map((group) => (
                    <div
                      key={group.company}
                      className="rounded-2xl border border-[#eadccf] bg-white/80 p-4"
                    >
