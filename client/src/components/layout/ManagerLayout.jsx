...
export default function ManagerLayout({ title, subtitle, children }) {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#f6f1ea]">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(120,72,36,0.16),_transparent_35%),radial-gradient(circle_at_bottom_right,_rgba(191,140,92,0.16),_transparent_35%)]" />
      <div className="absolute -left-20 top-10 h-72 w-72 rounded-full bg-[#c8a27c]/20 blur-3xl" />
